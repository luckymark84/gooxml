...
func (m *CT_Object) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if m.Shape != nil {
		m.Shape.MarshalXML(e, xml.StartElement{})
	}
	if m.OLEObject != nil {
		m.OLEObject.MarshalXML(e, xml.StartElement{})
	}
