...
import (
	...
	"github.com/luckymark84/gooxml/schema/soo/pkg/content_types"
)
...
func NewContentTypes() ContentTypes {
	...
	ct.AddDefault("bin", "application/vnd.openxmlformats-officedocument.oleObject")
	ct.AddDefault("docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
	ct.AddDefault("emf", "image/x-emf")
	ct.AddDefault("xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
